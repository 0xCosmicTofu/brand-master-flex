      ...
      <main className="flex-1 flex flex-col">
        <section className="flex-1 flex flex-col items-center justify-center px-6 py-24 text-center">
          <div className="max-w-3xl mx-auto space-y-8">
            <div className="inline-flex items-center gap-2 bg-[#A8E63D]/10 border border-[#A8E63D]/20 rounded-full px-4 py-1.5 text-xs font-medium text-[#A8E63D] mb-2">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/generator">
                <Button className="bg-[#A8E63D] text-black font-semibold hover:bg-[#96d630] px-8 py-6 text-base gap-2 rounded-lg">
        ...
        <section className="border-t border-zinc-900 px-6 py-16">
          <div className="max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-8">
            <div className="flex flex-col gap-3">
              <div className="w-8 h-8 rounded-lg bg-[#A8E63D]/10 flex items-center justify-center">
                <Zap className="h-4 w-4 text-[#A8E63D]" />
              </div>
              <h3 className="text-zinc-100 font-semibold">Instant output</h3>
            ...
            <div className="flex flex-col gap-3">
              <div className="w-8 h-8 rounded-lg bg-[#A8E63D]/10 flex items-center justify-center">
                <Shield className="h-4 w-4 text-[#A8E63D]" />
              </div>
              <h3 className="text-zinc-100 font-semibold">Brand-safe AI</h3>
              <p className="text-sm text-zinc-500 leading-relaxed">
            ...
            <div className="flex flex-col gap-3">
              <div className="w-8 h-8 rounded-lg bg-[#A8E63D]/10 flex items-center justify-center">
                <Copy className="h-4 w-4 text-[#A8E63D]" />
              </div>
              <h3 className="text-zinc-100 font-semibold">Export anywhere</h3>
              <p className="text-sm text-zinc-500 leading-relaxed">
